...
import { fadeInFromLeft, fadeInFromRightWithDelay } from "./animation"
  ...
  return (
    <>
      <div className='hero h-screen w-full bg-midnight_text relative overflow-hidden pt-44 pb-20'>
        ...
        <motion.div
          className="solution-box absolute lg:block hidden lg:bottom-5 bottom-0 lg:right-5 right-0 bg-white/10 backdrop-blur-sm p-8 max-w-md rounded-md z-10"
          variants={fadeInFromRightWithDelay}
          initial="initial"
          animate="animate"
        >
          <Icon
