...
import { headerVariants, gridContainerVariants, gridItemVariants } from './animation'
    ...
    <>
      <section className='bg-light overflow-hidden py-14 lg:py-18 xl:py-22 bg-prim-light'>
        <div className="container mx-auto lg:max-w-[--breakpoint-xl] md:max-w-[--breakpoint-md] px-4 space-y-14">
          ...
          >
            <motion.div variants={gridItemVariants} className='w-full bg-white p-8 rounded-2xl'>
            ...
            <motion.div variants={gridItemVariants} className='w-full bg-white p-8 rounded-2xl flex flex-col justify-between items-start md:col-span-2 lg:col-span-1'>
              <div className='mb-8'>
